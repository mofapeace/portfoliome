...
const sections = [
  {
    ...
    items: [
      { label: 'Logo 01', description: 'Minimal brandmark for a creative studio.' },
      { label: 'Logo 02', description: 'Tech-inspired mark for a digital consulting brand.' },
      { label: 'Logo 03', description: 'Modern geometric entity for an app launch.' },
    ],
  },
  {
    id: 'flyers',
